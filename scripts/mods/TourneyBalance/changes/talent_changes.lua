...
mod:add_text("kerillian_shade_activated_ability_phasing_desc", "Leaving Infiltrate grants Kerillian 10%% movement speed and 15%% power with the ability to pass through enemies for 10 seconds. Infiltrate no longer grants bonus damage. Reduced the cooldown of Infiltrate by 40%%.")
