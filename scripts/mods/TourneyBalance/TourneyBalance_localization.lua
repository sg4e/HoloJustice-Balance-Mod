...
local localization = {
	...
	mod_enabled = {
		en = "HoloJustice Mod Enabled.",
		fr = "HoloJustice Mod activé.",
		de = "HoloJustice Mod aktiviert.",
		it = "HoloJustice Mod abilitato.",
		pl = "HoloJustice Mod włączony.",
		zh = "HoloJustice 模组已启用。",
		ru = "HoloJustice Мод включен.",
		es = "HoloJustice Mod activado.",
		["br-pt"] = "HoloJustice Mod ativado.",
		ko = "HoloJustice 모드 활성화.",
	},
	...
	-- Pause
	not_server = {
		en = "HoloJustice You need to be host to pause!",
		fr = "HoloJustice Vous devez être l'hôte pour mettre en pause !",
		de = "HoloJustice Du musst Gastgeber sein, um anzuhalten!",
		it = "HoloJustice Devi essere l'host per mettere in pausa!",
		pl = "HoloJustice Musisz być gospodarzem, aby wstrzymać!",
		zh = "HoloJustice 你必须是主持人才可暂停！",
		ru = "HoloJustice Вы должны быть хостом, чтобы поставить на паузу!",
		es = "HoloJustice ¡Debes ser el anfitrión para pausar!",
		["br-pt"] = "HoloJustice Você precisa ser o anfitrião para pausar!",
		ko = "HoloJustice 일시정지하려면 호스트여야 합니다!",
	},
	game_unpaused = {
		en = "HoloJustice Game unpaused!",
		fr = "HoloJustice Jeu repris !",
		de = "HoloJustice Spiel fortgesetzt!",
		it = "HoloJustice Gioco ripreso!",
		pl = "HoloJustice Gra wznowiona!",
		zh = "HoloJustice 游戏已恢复！",
		ru = "HoloJustice Игра продолжена!",
		es = "HoloJustice ¡Juego reanudado!",
		["br-pt"] = "HoloJustice Jogo retomado!",
		ko = "HoloJustice 게임이 재개되었습니다!",
	},
	game_paused = {
		en = "HoloJustice Game paused!",
		fr = "HoloJustice Jeu en pause !",
		de = "HoloJustice Spiel pausiert!",
		it = "HoloJustice Gioco in pausa!",
		pl = "HoloJustice Gra wstrzymana!",
		zh = "HoloJustice 游戏已暂停！",
		ru = "HoloJustice Игра на паузе!",
		es = "HoloJustice ¡Juego en pausa!",
		["br-pt"] = "HoloJustice Jogo em pausa!",
		ko = "HoloJustice 게임이 일시정지되었습니다!",
	},
	...
	-- Restart
	restart_in_keep = {
		en = "HoloJustice You can't restart in the keep.",
		fr = "HoloJustice Vous ne pouvez pas redémarrer dans le refuge.",
		de = "HoloJustice Du kannst nicht im Zufluchtsort neu starten.",
		it = "HoloJustice Non puoi riavviare nel rifugio.",
		pl = "HoloJustice Nie możesz zrestartować w twierdzy.",
		zh = "HoloJustice 你无法在据点中重启。",
		ru = "HoloJustice Вы не можете перезапустить игру в убежище.",
		es = "HoloJustice No puedes reiniciar en la fortaleza.",
		["br-pt"] = "HoloJustice Você não pode reiniciar no santuário.",
		ko = "HoloJustice 요새에서는 재시작할 수 없습니다.",
	},
